...
//   return (
//     <div>
//         <h1 className='text-center'>Lerning useMemo</h1>
//        <h3 className='text-center'>{multipication}</h3> 
//         <button className='text' onClick={()=>setAdd(add + 1)}>Add</button> 
//          <span>{add}</span><br/>
  ...
  return (
    <>
      <div className="ch ">
          ...
          <div className="row">
            ...
            <div className="col-3  mx-5">
              ...
              <p className="">
                ...
                everything secure transactions and shipping.
              </p>
            </div>
            <div className="col-3 mx-5 ">
        ...
        <hr className=" fw-bold mt-5 mb-5"></hr>
        <div className="container">
          <div className="row">
